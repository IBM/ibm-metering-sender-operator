...
IMG ?= ibm-metering-sender-operator
...
bundle:
	...
	-mkdir bundle
	rm -rf bundle/*
	cp -r deploy/olm-catalog/ibm-metering-sender-operator/${CSV_VERSION}/* bundle/
	cp deploy/olm-catalog/ibm-metering-sender-operator/ibm-metering-sender-operator.package.yaml bundle/
