...
import (
	...
	"github.com/ibm/ibm-metering-sender-operator/pkg/apis"
	"github.com/ibm/ibm-metering-sender-operator/pkg/controller"
	"github.com/ibm/ibm-metering-sender-operator/version"
...
func main() {
	...
	err = leader.Become(ctx, "ibm-metering-sender-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
